    ...
    <AppLayout>
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        {groupEntries.length === 0 ? (
          ...
          <>
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="grid gap-3 sm:gap-4 grid-cols-1">>
